...
<html lang="en" class=" -webkit-"><head>
  <meta charset="UTF-8">
  <title>Freedhome - API</title>
	<link rel="apple-touch-icon" sizes="180x180" href="/assets/app-assets/img/SmooneyLogo/smooney.logo-box180.ico">
	<link rel="icon" type="image/png" sizes="32x32" href="/assets/app-assets/img/SmooneyLogo/smooney.logo-box32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="/assets/app-assets/img/SmooneyLogo/smooney.logo-box16.png">
...
<body>
  <h1 style="color: white; z-index: 10000; position: sticky; font-family: 'Nunito', sans-serif; letter-spacing: 5px;">
		FREEDHOME API
	</h1>
  <canvas id="c" width="1086" height="824"></canvas>
    ...
    <script>var w = c.width = window.innerWidth,
		...
		ctx.fillStyle = '#01223b';
		ctx.fillRect( 0, 0, w, h );
		ctx.fillStyle = '#01223b';
		ctx.font = '50px Verdana';
		ctx.fillText( 'Freedhome', w / 2 - ctx.measureText( 'Freedhome' ).width / 2, h / 2 - 15 );
